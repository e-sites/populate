...
return this.each(function(){var a=c.extend(i,g);"SELECT"===this.nodeName&&(c(this).find(a.exclude?"option:not()":"option").remove().end().append(d).removeAttr("disabled"),a.select&&c(this).children().removeAttr("selected").filter(a.select).attr("selected","selected"),a.onPopulate&&c.isFunction(a.onPopulate)&&a.onPopulate.apply(this,[d]))})}})})(jQuery);
